...
async function createDummy() {
    const id = uuidv4();
    const slug = `andaman-elite-exclusive`;
    ...
    const quotation = {
        ...
        destination: "Andaman Islands - The Elite Escape",
        pax: 2,
        duration: "5 Nights / 6 Days",
        travelDates: { from: "2026-06-12", to: "2026-06-17" },
        ...
        itinerary: [
            ...
            },
            {
                ...
                photos: ["https://images.unsplash.com/photo-1544735716-392fe2489ffa?auto=format&fit=crop&q=80&w=1000"]
            }
        ],
        includes: [
    ...
    try {
        ...
        `;
        console.log(`SUCCESS: Created SLUG: ${slug}`);
